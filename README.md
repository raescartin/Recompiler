...
The forest of NAND functions is very similar to the [And Inverter Graphs](https://en.wikipedia.org/wiki/And-inverter_graph) used in state of the art circuit minimization methods, like  Berkley's ABC.  
